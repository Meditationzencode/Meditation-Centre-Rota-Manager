 ...
 * Run after the numbered schema SQL files (01_schema.sql through
 * 09_length_checks.sql, excluding the optional 07_seed.sql) have been
...
const USERS = [
  ...
  { email: 'vol5@bodhigrove.demo',     password: 'Demo1234!', name: 'Grace O’Brien',   role: 'volunteer' },
  { email: 'vol6@bodhigrove.demo',     password: 'Demo1234!', name: 'Daniel Cohen',    role: 'volunteer' },
  { email: 'vol7@bodhigrove.demo',     password: 'Demo1234!', name: 'Aisha Rahman',    role: 'volunteer' },
  { email: 'vol8@bodhigrove.demo',     password: 'Demo1234!', name: 'Lucas Meyer',     role: 'volunteer' },
  { email: 'vol9@bodhigrove.demo',     password: 'Demo1234!', name: 'Hannah Schmidt',  role: 'volunteer' },
  { email: 'vol10@bodhigrove.demo',    password: 'Demo1234!', name: 'Mateo Rossi',     role: 'volunteer' },
  { email: 'vol11@bodhigrove.demo',    password: 'Demo1234!', name: 'Olivia Bennett',  role: 'volunteer' },
  { email: 'vol12@bodhigrove.demo',    password: 'Demo1234!', name: 'Noah Kim',        role: 'volunteer' },
  { email: 'vol13@bodhigrove.demo',    password: 'Demo1234!', name: 'Sofia Marino',    role: 'volunteer' },
  { email: 'vol14@bodhigrove.demo',    password: 'Demo1234!', name: 'Ethan Clarke',    role: 'volunteer' },
  { email: 'vol15@bodhigrove.demo',    password: 'Demo1234!', name: 'Leila Haddad',    role: 'volunteer' },
  { email: 'vol16@bodhigrove.demo',    password: 'Demo1234!', name: 'Arjun Mehta',     role: 'volunteer' },
  { email: 'vol17@bodhigrove.demo',    password: 'Demo1234!', name: 'Emma Larsson',    role: 'volunteer' },
  { email: 'vol18@bodhigrove.demo',    password: 'Demo1234!', name: 'Caleb Foster',    role: 'volunteer' },
  { email: 'vol19@bodhigrove.demo',    password: 'Demo1234!', name: 'Nadia Petrova',   role: 'volunteer' },
  { email: 'vol20@bodhigrove.demo',    password: 'Demo1234!', name: 'Ravi Anand',      role: 'volunteer' },
  { email: 'vol21@bodhigrove.demo',    password: 'Demo1234!', name: 'Chloe Dubois',    role: 'volunteer' },
  { email: 'vol22@bodhigrove.demo',    password: 'Demo1234!', name: 'Marcus Bell',     role: 'volunteer' },
  { email: 'vol23@bodhigrove.demo',    password: 'Demo1234!', name: 'Ingrid Olsen',    role: 'volunteer' },
  { email: 'vol24@bodhigrove.demo',    password: 'Demo1234!', name: 'Tariq Aziz',      role: 'volunteer' },
  { email: 'vol25@bodhigrove.demo',    password: 'Demo1234!', name: 'Freya Lindqvist', role: 'volunteer' },
  { email: 'vol26@bodhigrove.demo',    password: 'Demo1234!', name: 'Oscar Nguyen',    role: 'volunteer' },
  { email: 'vol27@bodhigrove.demo',    password: 'Demo1234!', name: 'Beatriz Costa',   role: 'volunteer' },
  { email: 'vol28@bodhigrove.demo',    password: 'Demo1234!', name: 'Samuel Adeyemi',  role: 'volunteer' },
  { email: 'vol29@bodhigrove.demo',    password: 'Demo1234!', name: 'Yara Mansour',    role: 'volunteer' },
  { email: 'vol30@bodhigrove.demo',    password: 'Demo1234!', name: 'Henry Walsh',     role: 'volunteer' },
]
